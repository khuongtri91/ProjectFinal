...
function UpdateAccountTypeForm() {
    const initialValues = {
    ...
    return (
        <div className="container mt-3">
            <h2>Update Account Type Form</h2> 
            <hr />
            <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit} className="w-75" >
                <Form className="w-50" >
                    <Field type="text" name="tenLoaiTaiKhoan" placeholder="Tên loại tài khoản" className="formGroup_input" autoComplete="off" />
                    <ErrorMessage name="tenLoaiTaiKhoan" component="span" class="errorMessage" />
...
export default UpdateAccountTypeForm;